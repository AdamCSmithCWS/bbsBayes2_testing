...
model {
  ...
  sdste ~ student_t(5,0,1); //prior on sd of site effects
  sdbeta ~ student_t(5,0,0.1); // prior on sd of differences among strata
  sdBETA ~ student_t(5,0,0.1); // prior on sd of mean hyperparameter differences
